...
import seederData from "./maintenance.seeder.json";
...
const MaintenanceSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MaintenanceSeederDialogComponent);
